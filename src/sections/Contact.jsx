                    ...
                    <div className="xl:col-span-5">
                        <div className="flex-center card-border rounded-xl p-10">
                            <form ref={formRef} onSubmit={handleSubmit} className="w-full flex flex-col gap-7">
                                ...
                                <div>
                                    <label htmlFor="phone">WhatsApp (with country code)</label>
                                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                                        <select
                                            name="countryCode"
                                            value={formData.countryCode}
                                            onChange={handleChange}
                                            className="px-4 py-4 md:text-base text-sm placeholder:text-blue-50 bg-blue-100 rounded-md w-full sm:w-20 text-white appearance-none text-center"
                                            style={{
                                        ...
                                        >
                                            {countryCodes.map((country) => (
                                                <option key={country.code} value={country.code} className="bg-blue-100 text-white">
                                                    {country.code}
                                                </option>
                                            ))}
                                        </select>
                                        <input
                                            ...
                                            className="w-full sm:flex-1 px-4 py-4 md:text-base text-sm placeholder:text-blue-50 bg-blue-100 rounded-md"
                                        />
                                    </div>
                                </div>
